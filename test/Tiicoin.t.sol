...
contract TestTiicoin is Test {
    ...
    function testTransferEmit() public {
        ...
        emit Transfer(address(this), address(0xbF418c1822274015B142715799C24B4Cb576866e), 500);
        tiicoin.transfer(address(0xbF418c1822274015B142715799C24B4Cb576866e), 500);
    }
}
